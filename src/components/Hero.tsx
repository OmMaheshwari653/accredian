      ...
      <div className="mx-auto w-full max-w-340">
        <div className="flex justify-center items-center my-4 mt-20 sm:mt-32 xl:px-12 sm:px-4 mb-10 md:mb-0">
          <div className="rounded-lg md:rounded-3xl bg-blue-50 flex flex-col-reverse sm:flex-row items-center justify-center sm:justify-between sm:gap-4 md:gap-8 lg:gap-12 shadow-card overflow-visible">
            <Reveal direction="left" className="w-full sm:w-1/2" amount={0.2}>
              <div className="flex w-full flex-col justify-between gap-4 p-4 sm:ml-7 sm:gap-4 sm:p-0 md:gap-8 md:ps-2 lg:gap-10 lg:ps-8">
            ...
            <Reveal direction="right" className="w-full sm:w-1/2" delay={0.08}>
              <div className="flex w-full justify-center sm:items-end sm:justify-end">
                <Image
                  src="/hero.webp"
                  alt="headerImage"
                  width={640}
