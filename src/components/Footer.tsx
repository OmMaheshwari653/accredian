      ...
      <div className="max-w-[85rem] w-full px-[22px] sm:px-0 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-700 sm:border-gray-200 pb-6">
            ...
            <div className="flex gap-4 mt-4">
              {socialLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="sm:text-gray-700 text-white hover:text-blue-600"
          ...
          <div className="mt-6 justify-center md:mt-0">
            <button className="p-2 sm:px-6 sm:py-2 bg-blue-600 text-sm sm:text-lg text-white font-normal rounded-lg">
              Enquire Now
            </button>
